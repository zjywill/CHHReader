...
public class PhotoManager {
	...
	/*
	 * Creates a cache of byte arrays indexed by image URLs. As new items are
	 * added to the cache, the oldest items are ejected and subject to garbage
	 * collection.
	 */
	...
	public void handleState(PhotoTask photoTask, int state) {
		...
		// The task finished downloading and decoding the image
			case TASK_COMPLETE :
				...
				// Gets a Message object, stores the state in it, and sends it
				// to the Handler
	...
	static public PhotoTask startDownload(PhotoView imageView,
		...
		if (null == downloadTask.getByteBuffer()) {
			...
			// and decoding.
			imageView.setStatusResource(R.drawable.gray_image_downloading);
