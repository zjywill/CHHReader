...
class PhotoDecodeRunnable implements Runnable {
    ...
    // Max width of preview limited to 400 to enhance the scroll
    ...
    */
    interface TaskRunnableDecodeMethods {
        ...
        /**
         * Get as preview value
         * @return The as preview value.
         */
        boolean getAsPreviewTag();
    }
    ...
    public void run() {
        ...
        try {
            ...
            int targetWidth;
            int targetHeight;
			if (mPhotoTask.getAsPreviewTag()) {
				targetWidth = mPhotoTask.getTargetWidth() > MAX_PREVIEW_WIDTH ? MAX_PREVIEW_WIDTH
						: mPhotoTask.getTargetWidth();
				targetHeight = mPhotoTask.getTargetHeight() * targetWidth
						/ mPhotoTask.getTargetWidth();
			} else {
				targetWidth = mPhotoTask.getTargetWidth();
