...
/**
 * Subclass of {@link android.support.v4.app.ListFragment} which provides
 * automatic support for providing the 'swipe-to-refresh' UX gesture by wrapping
...
public class SwipeRefreshListFragment extends ListFragment {
	 ...
	 * listen for initiated refreshes.
	 *
	 ...
	 * is currently refreshing or not.
	 *
	 ...
	 * only supports a single child, which it expects to be the one which
	 * triggers refreshes. In our case the layout's child is the content view
	 * returned from
