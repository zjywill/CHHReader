...
public class ContentListFragment extends SwipeRefreshListFragment implements
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		case LOADER_ID_LOACL: {
			...
			if (mCategory != 0) {
				selection = DataProvider.KEY_MAIN_TOPIC_PK + "='"
						+ mCategory
						+ "'"//
			...
			return new CursorLoader(getActivity(),
					DataProvider.CONTENT_URI_MAIN_DATA, projection, selection,
